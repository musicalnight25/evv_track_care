...
class Visit {
  ...
  factory Visit.fromJson(Map<String, dynamic> json) {
    return Visit(
      ...
      adjInDateTime: json['AdjInDateTime'] != null ? DateTime.parse(json['AdjInDateTime']) : DateTime.now(),
      adjOutDateTime: json['AdjOutDateTime'] != null ? DateTime.parse(json['AdjOutDateTime']) : DateTime.now(),
